...
export ZSH="/Users/zhangjunchao/.oh-my-zsh"
...
plugins=(git autojump zsh-autosuggestions git-open zsh-256color zsh-syntax-highlighting)
...
if brew list | grep coreutils > /dev/null ; then
    ...
    eval `dircolors ~/.dir-solarized/dircolors.ansi-universal`
fi
export CLICOLOR=1
